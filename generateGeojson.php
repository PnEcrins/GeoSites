...
$fichierGeojson = fopen('data/site_geol_tmp.geojson', 'r+');
fseek($fichierGeojson, 0);
$ligne1 = "{ \n";
$ligne2 = "\"type\": \"FeatureCollection\", \n";
$ligne3 = "\"crs\": { \"type\": \"name\", \"properties\": { \"name\": \"urn:ogc:def:crs:OGC:1.3:CRS84\" } }, \n";
$ligne4 = "\n";
$ligne5 = "\"features\": [ \n";

fputs($fichierGeojson, $ligne1);
fputs($fichierGeojson, $ligne2);
fputs($fichierGeojson, $ligne3);
fputs($fichierGeojson, $ligne4);
fputs($fichierGeojson, $ligne5);
